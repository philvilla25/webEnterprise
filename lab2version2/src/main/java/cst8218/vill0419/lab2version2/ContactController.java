...
import cst8218.vill0419.lab2version2.util.JsfUtil;
import cst8218.vill0419.lab2version2.util.PaginationHelper;
...
public class ContactController implements Serializable {
    ...
    private ContactJpaController jpaController = null;
    ...
    private ContactJpaController getJpaController() {
        if (jpaController == null) {
            jpaController = new ContactJpaController(utx, emf);
        }
        ...
        if (pagination == null) {
            pagination = new PaginationHelper(10) {
                ...
                public int getItemsCount() {
                    return getJpaController().getContactCount();
                }

                @Override
                public DataModel createPageDataModel() {
                    return new ListDataModel(getJpaController().findContactEntities(getPageSize(), getPageFirstItem()));
                }
            };
        }
        return pagination;
    ...
    private void updateCurrentItem() {
        int count = getJpaController().getContactCount();
        ...
        if (selectedItemIndex >= 0) {
            current = getJpaController().findContactEntities(1, selectedItemIndex).get(0);
        }
    }
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItems(getJpaController().findContactEntities(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItems(getJpaController().findContactEntities(), true);
    }
    ...
    public static class ContactControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getJpaController().findContact(getKey(value));
        }
